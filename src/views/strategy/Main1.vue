...
<template>
    ...
    <div class="w-full h-full md:h-full bg-third">
      <div class="flex flex-col  rounded-lg mx-2 mt-2">
        ...
        <div class="min-h-[50vh] bg-secondary">
          <div v-if="showTableData && reorderedPlans.length">
            ...
            <div class="visible sm:hidden">
              <div class="flex justify-between font-bold bg-third text-tabletext dark:bg-primary py-3 px-4 shadow border-b dark:border-tableText dark:shadow-tabletext">
