<template>
  <div class="mx-2"> 
    ...
    <div class="intro-y border rounded flex items-center mt-2 dark:text-white">
    ...
    <div>
      <!-- BEGIN: Profile Info -->
      <div class="intro-y border shadow rounded box px-5 pt-5 mt-5">
        <div
        ...
        >
          ...
          >
            <div class="flex justify-center lg:justify-start">
              ...
              >
                <div class="font-medium flex justify-center lg:justify-start lg:mt-3mb-2">
                  Contact Details
                </div>
...
import Billing from "./billing.vue";
  ...
  .intro-y {
    @apply bg-third dark:bg-[#1F242A] dark:border-none;
    box-shadow: 
