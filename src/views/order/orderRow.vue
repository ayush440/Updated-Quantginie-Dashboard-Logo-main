        ...
        <div v-if="fullDetails" class="p-2 capitalize">
            ...
            <div class="flex items-center justify-between px-2 py-1">
                ...
                <div class="flex items-center">
                    <component v-if="containsIcon()" :is="order.strategy.image_url" class="h-3 w-3"
                        :style="{ color: order.strategy.color, strokeWidth: 2.5 }"
                    />
            ...
            <div v-if="order.status_message" class="flex items-center justify-between px-2 py-1 bg-white bg-opacity-5">
