<template>
    <div :id="id" ref="dropdownCont" :class="{'relative': true}" >
        ...
        <transition name="dropdown-slide">
            <div v-if="isOpen" ref="dropdown" :style ="{ zIndex: zIndexValue }" class="absolute dropdown-body p-2 w-80 right-[50%] top-12 mt-2 bg-secondary dark:bg-third-light dark:text-gray-50 rounded-md shadow-md dark:shadow-third" :class ="dropdownClass">
